...
def functions_and_gradients(C,x0,fixed_nodes,target_pc, motor, idx=None,device=device_used,timesteps=2000):
...
def solve_mechanism(C,x0,fixed_nodes, motor, device=device_used, timesteps=2000):
...
def evaluate_mechanism(C,x0,fixed_nodes, motor, target_pc, idx=None,device=device_used,timesteps=2000):
    ...
    for i in trange(6):
        if os.path.exists('./results/%i.csv'%i):
            ...
            for m in mechanisms:
                ...
                # Solve
                valid, CD, material, _ = evaluate_mechanism(C,x0,fixed_nodes, motor, target_curves[i], target, device=device_used,timesteps=2000)
